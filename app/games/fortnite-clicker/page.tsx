...
export default function FortniteClickerPage() {
  ...
  return (
    <div className="bg-[#1a1a1a]">
            <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"VideoGame","name":"Fortnite Clicker","description":"Play Fortnite Clicker online for free. Tap to earn V-Bucks, unlock upgrades, and progress fast. Switch to Local Mode anytime for instant play.","genre":"Clicker Game","gamePlatform":"Web Browser","author":{"@type":"Organization","name":"Roblox Clicker"}}) }} />
